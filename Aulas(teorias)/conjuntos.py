...
print(f'Set: {s} com {len(s)} elementos')
...
# informam manuamente a cidade de onde vieram.
...
# OBS: Se o valor não encontrado, nenhum erro é gerado.
...
# Forma 2 - Utilizando o caractére pipe |
...
# Forma 1 - Utilizando inteserction
