...
OBS: Não precisamos necessariamente criarmos uma variável para receber o retorno
...
def diz_oi():
    print("Estou sendo executada antes do retorno...")
    return 'Oi'
...
# Erros comuns na utilização do retorno, que na verdade nem é erro, mas sim codificção desnecessária.
