...
all() -> Retorna True se todos os elementos de um iterável são verdadeiros ou ainda se o iterável está vazio.
...
print(all([letra for letra in 'adeiu' if letra in 'aeiou']))
...
print([num for num in [4, 2, 10, 6, 8, 9] if num % 2 == 0])
